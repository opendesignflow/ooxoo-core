 ...
 *
 */
public class TypeResolver extends ExtensionFunctionDefinition {
		...
		return new ExtensionFunctionCall() {
			...
			public SequenceIterator call(SequenceIterator[] si,
				...
				if (nsuri.length()==0) {
					...
					return Value.asIterator(StringValue.makeStringValue(TypeResolver.types.get(type).getCanonicalName()));
